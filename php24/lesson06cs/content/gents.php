...
on each square cust tail, quilted black silk lining, very good; ';
...
<ul class="ulfancy">
	...
	<li class="row<?php echo $i % 2; ?>">
		<div class="list-photo">
			<a href="images/<?php echo $lots[$i]['image']; ?>"> <img
				src="images/thumbnails/<?php echo $lots[$i]['image']; ?>" alt="" /></a>
		</div>
		<div class="list-description">
			<h2><?php echo ucwords($lots[$i]['name']); ?></h2>
			<p><?php echo htmlspecialchars($lots[$i]['description']); ?></p>
			<p>
				<strong>Lot:</strong> #<?php echo $lots[$i]['lot_number']; ?> 
