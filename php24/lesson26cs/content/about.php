...
?>
<h1>
	About Us<a class="button" href="index.php?content=contactmaint&id=0">Add</a>
</h1>
<p>We are all happy to be a part of this. Please contact any of us with
	questions.</p>
...
<ul class="ulfancy">
  <?php foreach ($items as $i=>$item) : ?>
    <li class="row<?php echo $i % 2; ?>">
      ...
      Phone: <?php echo htmlspecialchars($item->getPhone()); ?><br />
		</p>
	</li>
  <?php endforeach; ?>
</ul>